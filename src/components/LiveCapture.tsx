...
import { verifyImageAI, saveCapture } from '../lib/apiClient';
...
export default function LiveCapture({ onCaptureCompleted, onNavigateToTab }: LiveCaptureProps) {
  ...
  const triggerCapture = async () => {
    ...
    try {
      ...
      // Submit to Google GenAI context using apiClient helper
      const aiResult = await verifyImageAI(
        capturedDataUrl,
        lat,
        lng,
      ...
      // Push to database to sync seamlessly
